...
class RollingSwitch extends StatefulWidget {
  const RollingSwitch.icon({
    ...
    this.height = 50,
    this.innerSize = 40,
    this.circularColorRight = Colors.white,
    this.circularColorLeft = Colors.white,
  ...
  final Color circularColorLeft;

  /// [circularColor] color for the circular icon wrapper
  final Color circularColorRight;
  ...
  void initState() {
    ...
    animationController = AnimationController(
      ...
      duration: widget.animationDuration,
        ...
        if ((animationController.value == 0.0 && turnState) ||
            (animationController.value == 1.0 && !turnState)) {
          turnState = !turnState;
                  ...
                  child: AnimatedBuilder(
                    ...
                    child: Align(
                      ...
                      child: CircularContainer(
                        ...
                        color: animationController.value > .5
                            ? widget.circularColorRight
                            : widget.circularColorLeft,
